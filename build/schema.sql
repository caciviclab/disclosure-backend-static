...
\restrict JXfWbmdlaQtfnrgboyLtTEelpC9OgavdhvCrFEsTRNPkLEdWVEUE6p6MoIGbs7r
...
CREATE TABLE public."A-Contributions" (
    ...
    "Elect_Date" date,
    "tblCover_Office_Cd" character varying(64),
    "tblCover_Offic_Dscr" character varying(64),
    "Rec_Type" character varying(4) NOT NULL,
    ...
    "Tran_Adr1" character varying(64),
    "Tran_Adr2" character varying(64),
    ...
    "Cmte_ID" character varying(9),
    "Tres_NamL" character varying(64),
    "Tres_NamF" character varying(64),
    "Tres_NamT" character varying(64),
    "Tres_NamS" character varying(64),
    "Tres_Adr1" character varying(64),
    "Tres_Adr2" character varying(64),
    "Tres_City" character varying(64),
    "Tres_State" character varying(4),
    "Tres_Zip" integer,
    "Intr_NamL" character varying(128),
    "Intr_NamF" character varying(64),
    "Intr_NamT" character varying(64),
    "Intr_NamS" character varying(64),
    "Intr_Adr1" character varying(64),
    "Intr_Adr2" character varying(64),
    "Intr_City" character varying(32),
    "Intr_State" character varying(4),
    "Intr_Zip4" character varying(10),
    "Intr_Emp" character varying(64),
    "Intr_Occ" character varying(32),
    "Intr_Self" boolean NOT NULL,
    "Cand_NamL" character varying(64),
    "Cand_NamF" character varying(64),
    "Cand_NamT" character varying(64),
    "Cand_NamS" character varying(64),
    "tblDetlTran_Office_Cd" character varying(4),
    "tblDetlTran_Offic_Dscr" character varying(19),
    "Juris_Cd" character varying(4),
    "Juris_Dscr" character varying(64),
    "Dist_No" character varying(64),
    "Off_S_H_Cd" character varying(64),
    "Bal_Name" character varying(64),
    "Bal_Num" character varying(4),
    "Bal_Juris" character varying(64),
    "Sup_Opp_Cd" character varying(64),
    "Memo_Code" character varying(64),
    "Memo_RefNo" character varying(11),
    "BakRef_TID" character varying(64),
    "XRef_SchNm" character varying(64),
    "XRef_Match" character varying(64),
    "Loan_Rate" character varying(64),
    "Int_CmteId" character varying(32)
);
...
CREATE TABLE public."F-Expenses" (
    ...
    "Tran_ID" character varying(16) NOT NULL,
    "Entity_Cd" character varying(3) NOT NULL,
    "Payee_NamL" character varying(128) NOT NULL,
    "Payee_NamF" character varying(32),
    "Payee_NamT" character varying(32),
    "Payee_NamS" character varying(32),
    "Payee_Adr1" character varying(32),
    "Payee_Adr2" character varying(32),
    ...
    "Tres_ZIP4" character varying(32),
    "Memo_Code" character varying(32),
    "Memo_RefNo" character varying(16),
    "BakRef_TID" character varying(32),
    "XRef_SchNm" character varying(32),
    "XRef_Match" character varying(4)
);
...
CREATE TABLE public."F461P5-Expenditure" (
    ...
    "Bus_ZIP4" integer,
    "Bus_Inter" character varying(64),
...
CREATE TABLE public."F465P3-Expenditure" (
    ...
    "Entity_Cd" character varying(3) NOT NULL,
    "Payee_NamL" character varying(64) NOT NULL,
    ...
    "Agent_NamL" character varying(64),
    "Agent_NamF" character varying(32),
    "Agent_NamT" character varying(32),
    "Agent_NamS" character varying(32),
    ...
    "Dist_No" character varying(4),
    "Off_S_H_Cd" character varying(32),
    "Bal_Name" character varying(200),
    "Bal_Num" character varying(4),
    "Bal_Juris" character varying(32),
    "Sup_Opp_Cd" character varying(1) NOT NULL,
    "Memo_Code" character varying(32),
...
CREATE TABLE public."F496P3-Contributions" (
    ...
    "Tran_Dscr" character varying(64),
    "Cmte_ID" character varying(9),
    "Tres_NamL" character varying(32),
    "Tres_NamF" character varying(32),
    "Tres_NamT" character varying(32),
...
\unrestrict JXfWbmdlaQtfnrgboyLtTEelpC9OgavdhvCrFEsTRNPkLEdWVEUE6p6MoIGbs7r
